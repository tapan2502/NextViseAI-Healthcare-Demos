      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card data-testid="avatar-consultation-card">
          <CardContent className="p-6">
            ...
            <div className="avatar-container rounded-lg p-6 min-h-[200px] flex items-center justify-center border border-border">
              <div className="text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-secondary to-primary rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-user-doctor text-white text-2xl"></i>
                </div>
                <p className="font-medium text-foreground">Dr. Sarah Wilson</p>
                <p className="text-sm text-muted-foreground">Virtual Consultation Available</p>
                <Button className="mt-3 bg-secondary hover:bg-secondary/90" size="sm">
                  Start Consultation
                </Button>
              </div>
            </div>
